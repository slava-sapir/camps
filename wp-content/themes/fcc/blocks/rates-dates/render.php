...
<section id="rates-dates">
    <div class="container position-relative">
      ...
      <div class="nav nav-tabs gap-5 ms-5" id="nav-tab" role="tablist">
            ...
            ?>
              ...
              <a href="javascript:void(0);" 
                  role="presentation" 
                  class="presentation-tab p-20 rounded-1 border border-3 border-tan d-flex align-items-center justify-content-center <?= $count == 1 ? 'active' : ''; ?>"
                  ...
                  <span class="fs-5 fw-semibold text-center"><?php echo $city_name; ?></span>
              </a>
            <?php endwhile; endif; ?>
      </div>
      ...
      <div class="tab-content mb-50">
          ...
          ?>
            ...
            data-text="<?= esc_attr(get_sub_field('text')); ?>">
              ...
              <div class="w-100 w-lg-75 d-flex flex-column gap-10 position-absolute mt-n300 mt-xl-n250 start-50 translate-middle-x">
                <h3 class="text-center text-grey600"><?= esc_attr(get_sub_field('title')); ?></h3>
                <p class="fs-5 fw-normal text-center text-grey600"><?= esc_attr(get_sub_field('text')); ?></p>
              </div>
      ...
      <div class="d-flex justify-content-center">
        <a href="<?= $register_link['url']; ?>" class="btn btn-gold mb-50 mx-auto"><?= $register_link['title']; ?></a>
      </div>
      <?php endif; ?>
