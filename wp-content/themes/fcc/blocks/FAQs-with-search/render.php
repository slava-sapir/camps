        ...
        <div class="row gx-lg-50 gx-xxl-120">
            <div class="col-lg-4">
                ...
                <form role="search" method="get" id="search-form" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
                    ...
                    <input type="text" value="<?php echo get_search_query(); ?>" name="s" id="s" placeholder="Input keywords"  />
                    ...
                    <div id="faq-accordion" class="accordion">
                        <?php while ( $query->have_posts() ) : $query->the_post();
                            ...
                            <div class="accordion-item mb-20">
                                ...
                                <div id="collapse-<?= $i; ?>" class="accordion-collapse collapsed collapse" aria-labelledby="headingOne" data-bs-parent="#faq-accordion">
