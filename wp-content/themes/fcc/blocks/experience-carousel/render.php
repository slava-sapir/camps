...
<section id="experience-carousel" class="bg-gold bg-secondary-gradient mb-50">
    ...
    <div class="bottom-splash hp-1400 hp-sm-1000 hp-md-1200 hp-xl-800 position-relative">
      ...
      <div class="d-flex flex-column-reverse flex-xl-row align-items-center">
        ...
        <div class="d-flex align-item-center justify-content-center w-100 w-xl-50 border-bottom border-1 border-white">
            <div class="d-flex flex-column gap-30 gap-md-80">
             <h2 class="text-white text-center"><?= get_field('main_title'); ?></h2>
                    ...
                    ?>
                      <a href="javascript:void(0);" role="presentation" class="presentation hp-171 nav-link d-flex justify-content-center align-items-end position-relative <?= $count == 1 ? 'active' : ''; ?>"
                            ...
                            <div class="click-event mb-n16 flex-column justify-content-center align-items-center <?= $count == 1 ? 'd-flex' : 'd-none'; ?>">
                                ...
                                <div class="fs-6 fw-semibold text-white txt pt-10 pb-5"><?= $experience_title ?></div>
                                <div class="d-flex flex-column align-items-center justify-content-center">
                                  <div class="wp-2 hp-20 bg-white"></div> 
                                  <div class="bordered-ball border border-2 border-white rounded-circle d-flex align-items-center justify-content-center wp-20 hp-20">
                                    <div class="bg-white rounded-circle wp-10 hp-10"></div>
                                  </div>
                                </div>
                            </div>
